...
const Index = () => {
    ...
    return <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center animate-fade-in-up">
          ...
          <div className="flex justify-center mt-6 space-x-1">
            {Array.from({
            length: 5
          }).map((_, i) => <div key={i} className="w-1 bg-primary rounded-full sound-bar" style={{
            height: '4px',
  ...
  return <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        {Array.from({
        length: 50
      }).map((_, i) => <div key={i} className="absolute w-1 h-1 bg-primary/10 rounded-full animate-float" style={{
      ...
      {/* Header */}
      <Header onSearch={handleSearch} onNavigate={handleNavigate} onToggleChat={toggleChat} />

      {/* Main Content */}
      <main className="pt-20 min-h-screen">
        {currentView === 'home' && <div className="animate-fade-in-up">
            {/* Hero Section */}
            <section className="relative py-20 px-4 text-center overflow-hidden">
              ...
              <div className="relative z-10 container mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-4 animate-fade-in-up animate-delay-300">
                  <div className="glass border border-glass-border rounded-full text-sm text-muted-foreground backdrop-blur-sm px-[22px] py-[9px] mx-0 my-0">
            ...
            <section className="py-20 px-4">
              ...
              }].map((feature, index) => <div key={feature.title} className="p-6 glass border border-glass-border rounded-xl hover-lift hover-glow
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <div className="w-2 h-20 bg-surface/30 rounded-full backdrop-blur-sm">
          <div className="w-full bg-gradient-primary rounded-full transition-all duration-300" style={{
